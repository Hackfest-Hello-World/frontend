    ...
    const fetchSentimentData = async () => {
      try {
        const response = await fetch(
          'https://5qb2m665-5010.inc1.devtunnels.ms/'
            ...
            >
              ...
              <p className='mt-3'>
                <span className='text-lg font-semibold'>
                  {item.title === 'Negative Feedback Alerts'
                    ? sentimentData.total_neg
                    : item.title === 'Social Media Mentions'
                    ? (sentimentData.total_pos || 0) +
                      (sentimentData.total_neg || 0)
                    : item.amount}
                </span>
              </p>
      ...
      <div className='mt-8 grid grid-cols-1 lg:grid-cols-3 gap-6'>
        ...
        <div className='space-y-4'>
          <Link
            ...
            state={{ platform: 'twitter-analysis' }}
          >
            <div
              ...
              <div className='flex justify-between items-center h-full'>
                <div>
                  ...
                  <p className='text-gray-200 mt-2'>
                    Positive%:{' '}
                    {sentimentData.platforms?.twitter?.positive?.toFixed(2) ||
                      0}{' '}
                    | Negative%:{' '}
            ...
            >
              <div>
                ...
                <p className='mt-2 text-white text-opacity-90'>
                  Positive%:{' '}
                  {sentimentData.platforms?.instagram?.positive?.toFixed(2) ||
                    0}{' '}
                  | Negative%:{' '}
