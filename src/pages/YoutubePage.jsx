...
const YouTubeSentimentPage = () => {
  ...
  return (
    <div className="mt-12">
      ...
      {data.map((video, idx) => (
        <div key={idx} className="bg-white dark:text-gray-200 dark:bg-secondary-dark-bg rounded-xl m-6 p-6 shadow-lg">
          <div className="flex flex-col md:flex-row gap-6 mb-6">
            ...
            <div className="md:w-1/2 w-full flex flex-col justify-center">
              ...
              <div className="mt-4 text-sm">
                ...
                <p><strong>Comments:</strong> {video.comments_count}</p>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row gap-4">
            <div className="w-full md:w-1/2 max-h-52 overflow-y-auto pr-2">
              <h3 className="text-md font-semibold mb-2 text-green-600">Top Positive</h3>
              <ul className="list-disc pl-4 text-sm">
                {video.top_positive_comments.map((comment, i) => (
                  <li key={i} className="mb-1">"{comment}"</li>
                ))}
              </ul>
            </div>
            <div className="w-full md:w-1/2 max-h-52 overflow-y-auto pr-2">
              <h3 className="text-md font-semibold mb-2 text-red-600">Top Negative</h3>
              <ul className="list-disc pl-4 text-sm">
